...
dfAp.columns = ['ID', 'profondeur', 'chl_a_Sonde', 'chl_a_Chimie']
...
B0_max = df[df.depth_max == 30].chl_a.max()
...
if optimization:
    ...
    for i,imonth in enumerate(imonths):
        ...
        for g_, df_ in data:
            ...
            # optimization
            z, chlCh, chlS = df_.profondeur, df_['chl_a_Sonde'].values, df_['chl_a_Chimie'].values
